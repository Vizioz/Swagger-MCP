...
function testFormatSuffix() {
  ...
  const pdfOperation = { produces: ['application/pdf'] };
  ...
  const csvOperation = { produces: ['text/csv'] };
  ...
  const excelOperation = { produces: ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'] };
  ...
  const htmlOperation = { produces: ['text/html'] };
  ...
  const xmlOperation = { produces: ['application/xml'] };
  ...
  const txtOperation = { produces: ['text/plain'] };
  ...
  const jsonOperation = { produces: ['application/json'] };
  ...
  // Test with PDF content type
  const pdfResponseOperation = { responses: { '200': { content: { 'application/pdf': {} } } } };
  ...
  // Test with CSV content type
  const csvResponseOperation = { responses: { '200': { content: { 'text/csv': {} } } } };
  ...
  // Test with Excel content type
  const excelResponseOperation = { responses: { '200': { content: { 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': {} } } } };
  ...
  // Test with HTML content type
  const htmlResponseOperation = { responses: { '200': { content: { 'text/html': {} } } } };
  ...
  // Test with XML content type
  const xmlResponseOperation = { responses: { '200': { content: { 'application/xml': {} } } } };
  ...
  // Test with TXT content type
  const txtResponseOperation = { responses: { '200': { content: { 'text/plain': {} } } } };
  ...
  // Test with JSON content type (should not add a suffix)
  const jsonResponseOperation = { responses: { '200': { content: { 'application/json': {} } } } };
